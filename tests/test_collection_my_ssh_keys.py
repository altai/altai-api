...
from altai_api.collection import my_ssh_keys
...
class KeypairFromNovaTestCase(MockedTestCase):
    ...
    def test_keypair_from_nova_works(self):
        ...
        with self.app.test_request_context():
            data = my_ssh_keys._keypair_from_nova(kp)
...
class MySShKeysListTestCase(MockedTestCase):
    ...
    def setUp(self):
        ...
        self.mox.StubOutWithMock(my_ssh_keys, '_keypair_from_nova')
    ...
    def test_list_works(self):
        ...
        self.fake_client_set.compute.keypairs.list()\
                .AndReturn(['K1', 'K2'])
        my_ssh_keys._keypair_from_nova('K1').AndReturn('REPLY1')
        my_ssh_keys._keypair_from_nova('K2').AndReturn('REPLY2')
...
class CreateMySshKeyTestCase(MockedTestCase):
    ...
    def test_generate_pair(self):
        ...
        self.fake_client_set.compute.keypairs.create(kp.name, None)\
                .AndReturn(kp)
        my_ssh_keys._keypair_from_nova(kp).AndReturn({'FAKE': 1})
    ...
    def test_upload_public(self):
        ...
        self.fake_client_set.compute.keypairs.create(kp.name, 'PUBLIC')\
                .AndReturn(kp)
        my_ssh_keys._keypair_from_nova(kp).AndReturn('REPLY')
